...
.month-btn { width: 70rpx; height: 70rpx; border-radius: 50%; background: #fff; text-align: center; line-height: 70rpx; font-size: 40rpx; color: #f8a5c2; box-shadow: 0 4rpx 16rpx rgba(0,0,0,0.06); }
.month-text { font-size: 32rpx; font-weight: bold; color: #333; letter-spacing: 2rpx; }
.summary-card {
...
.s-title { display: block; font-size: 30rpx; font-weight: bold; color: #333; }
.s-sub { display: block; font-size: 24rpx; color: #999; margin-top: 8rpx; }
.section { background: #fff; border-radius: 24rpx; margin: 20rpx 30rpx; padding: 24rpx 30rpx; }
...
.mood-name { width: 140rpx; font-size: 26rpx; color: #333; }
.mood-bar { flex: 1; height: 20rpx; background: #f5f5f5; border-radius: 10rpx; overflow: hidden; margin: 0 16rpx; }
.mood-fill { height: 100%; background: linear-gradient(90deg, #f8a5c2, #c44dff); border-radius: 10rpx; transition: width .5s; }
.mood-count { font-size: 22rpx; color: #999; flex-shrink: 0; }

...
.progress-card {
  background: linear-gradient(135deg, #fff0f5, #f3ecff);
  border-radius: 24rpx; margin: 30rpx; padding: 30rpx;
  display: flex; align-items: center; flex-wrap: wrap;
}
.p-emoji { font-size: 60rpx; margin-right: 20rpx; }
.p-main { flex: 1; }
.p-title { display: block; font-size: 32rpx; font-weight: bold; color: #333; }
.p-sub { display: block; font-size: 24rpx; color: #999; margin-top: 6rpx; }
...
.add-row { display: flex; align-items: center; margin: 0 30rpx 24rpx; background: #fff; border-radius: 16rpx; padding: 12rpx 20rpx; }
.add-input { flex: 1; font-size: 28rpx; }
.add-btn { background: linear-gradient(135deg, #f8a5c2, #ff6b9d); color: #fff; }
.section { background: #fff; border-radius: 24rpx; margin: 0 30rpx; padding: 10rpx 30rpx; }
.wish-item { display: flex; align-items: center; padding: 24rpx 0; border-bottom: 1rpx solid #f5f5f5; }
.wish-item:last-child { border-bottom: none; }
.wish-item.done .w-content { text-decoration: line-through; color: #bbb; }
.check {
  width: 44rpx; height: 44rpx; border-radius: 50%; border: 3rpx solid #e5e5e5;
...
.w-main { flex: 1; }
.w-content { display: block; font-size: 30rpx; color: #333; }
.w-owner { display: block; font-size: 22rpx; color: #bbb; margin-top: 4rpx; }
.w-del { color: #ccc; font-size: 28rpx; padding: 8rpx; }
.empty { text-align: center; color: #bbb; font-size: 26rpx; padding: 50rpx 0; }
</style>

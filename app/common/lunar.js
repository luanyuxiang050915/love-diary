// ========== 农历/公历互转（1900-2100），源自 yize/solarlunar（ISC 开源协议） ==========
// 供纪念日日历标注农历节日使用。
// solar2lunar(y, m, d)   -> { lYear, lMonth, lDay, monthCn, dayCn, ... }（非法返回 -1）
// getFestivals(y, m, d)  -> 农历节日名称数组，如 ['春节', '元宵节']
...
export function getFestivals(y, m, d) {
  return solarLunar.getFestivals(y, m, d);
}
